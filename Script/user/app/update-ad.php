...
$short_desc = ucfirst($_POST['shortdesc']);
	...
	$stmt = $conn->prepare("UPDATE tbl_ads SET title = :title, category = :category, fuel = :fuel, ad_condition = :adcond, price = :price, short_desc = :shortdesc, fixed = :fixed, brand = :brand, description = :description WHERE ad_id = :adid AND author = :author");
